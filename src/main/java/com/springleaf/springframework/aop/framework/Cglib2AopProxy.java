...
/**
 * Cglib 实现动态代理
 * Spring在运行期间通过 CGlib 继承要被动态代理的类，重写父类的方法，实现AOP面向切面编程
...
public class Cglib2AopProxy implements AopProxy {
    ...
    // ReflectiveMethodInvocation：核心类，激发拦截链工作实现。该类实现了aop联盟的MethodInvocation，间接实现了Invocation和JoinPoint
