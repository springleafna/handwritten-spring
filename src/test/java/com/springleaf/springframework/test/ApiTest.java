...
import com.springleaf.springframework.aop.framework.ReflectiveMethodInvocation;
import com.springleaf.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import com.springleaf.springframework.test.bean.UserServiceBeforeAdvice;
...
public class ApiTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* com.springleaf.springframework.test.bean.IUserService.*(..))");
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* com.springleaf.springframework.test.bean.IUserService.*(..))");
